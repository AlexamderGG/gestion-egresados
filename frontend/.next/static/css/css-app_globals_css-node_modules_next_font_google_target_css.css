...
.border-primary {
  --tw-border-opacity: 1;
  border-color: rgb(15 59 92 / var(--tw-border-opacity, 1));
}
.border-transparent {
...
.bg-primary {
  --tw-bg-opacity: 1;
  background-color: rgb(15 59 92 / var(--tw-bg-opacity, 1));
}
.bg-purple-200 {
  --tw-bg-opacity: 1;
...
.text-primary {
  --tw-text-opacity: 1;
  color: rgb(15 59 92 / var(--tw-text-opacity, 1));
}
...
/* Forzar estilos sólidos para Select/Dropdown */
...
/* Estilos para el trigger del Select */
[data-state="open"] {
  background-color: white !important;
...
.hover\:bg-primary\/80:hover {
  background-color: rgb(15 59 92 / 0.8);
}

.hover\:bg-primary\/90:hover {
  background-color: rgb(15 59 92 / 0.9);
}
