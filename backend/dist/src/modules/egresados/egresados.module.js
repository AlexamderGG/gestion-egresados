...
const egresados_controller_1 = require("./egresados.controller");
...
exports.EgresadosModule = EgresadosModule = __decorate([
    (0, common_1.Module)({
        controllers: [egresados_controller_1.EgresadosController],
        providers: [egresados_service_1.EgresadosService, prisma_service_1.PrismaService],
